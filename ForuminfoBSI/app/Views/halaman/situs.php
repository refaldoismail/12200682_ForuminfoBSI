...
<!-- DEBUG-VIEW ENDED 2 APPPATH\Views\widget\sidebar.php -->
        ...
        <div class="card">
            <div class="card-header">
                <h2 class="card-title">SELAMAT DATANG DI SITUS UBSI</h2>
            </div>
            <div class="card-body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                                ...
                                <td>1</td>
                                <td>MyBest</td>
                                <td>http://elearning.bsi.ac.id/</td>
                                <td>
                                    <a  href="http://elearning.bsi.ac.id/"
                                        class="btn btn-sm btn-success"> KUNJUNGI </a>
                                ...
                                <td>2</td>
                                <td>Student BSI</td>
                                <td>http://students.bsi.ac.id/</td>
                                <td>
                                    <a  href="http://students.bsi.ac.id/"
                                        class="btn btn-sm btn-success"> KUNJUNGI </a> 
                                ...
                                <td>3</td>
                                <td>Ruang Alumni</td>
                                <td>http://alumni.bsi.ac.id/</td>
                                <td>
                                    <a  href="http://alumni.bsi.ac.id/"
                                    class="btn btn-sm btn-success"> KUNJUNGI </a> 
                                ...
                                <td>4</td>
                                <td>Ujian Online</td>
                                <td>http://www.bsi.ac.id/ujian/</td>
                                <td>
                                    <a  href="http://www.bsi.ac.id/ujian/"
                                    class="btn btn-sm btn-success"> KUNJUNGI </a>   
                                ...
                                <td>5</td>
                                <td>Karyawan</td>
                                <td>http://staff.bsi.ac.id/</td>
                                <td>
                                    <a  href="http://staff.bsi.ac.id/"
                                    class="btn btn-sm btn-success"> KUNJUNGI </a> 
                                                    ...
                                                    <tr>
                                <td>6</td>
                                <td>Kemahasiswaan Ubsi</td>
                                <td>https://kemahasiswaan.bsi.ac.id/</td>
                                <td>
                                    <a  href="https://kemahasiswaan.bsi.ac.id/"
                                    class="btn btn-sm btn-success"> KUNJUNGI </a> 
