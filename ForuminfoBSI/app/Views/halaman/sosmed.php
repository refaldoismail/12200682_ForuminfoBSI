...
<!-- DEBUG-VIEW ENDED 2 APPPATH\Views\widget\sidebar.php -->
        ...
        <div class="card">
            <div class="card-header"><br>
                <h2 class="card-title">SOSIAL MEDIA UBSI</h2><br/>
            ...
            <div class="card ml-5 text-white text-center" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="https://www.instagram.com/kuliahbsiaja/" class="btn btn-danger">FOLLOW</a>
              </div>
            </div>
            ...
            <div class="card ml-5 text-white text-center" style="width: 18rem;">
              ...
              <div class="card-body">
                ...
                <a href="https://web.facebook.com/Bina-Sarana-Informatika-201434683230801/" class="btn btn-success">LIKE&SHERE</a>
              </div>
            </div>

            <div class="card ml-5 text-white text-center" style="width: 18rem;">
              <div class="card-header bg-info display-4 pt-4 pb-4"></div>
              <div class="card-body">
                <h5 class="card-title text-info">TWITTER</h5>
                <a href="https://twitter.com/kuliahbsiaja" class="btn btn-info">FOLLOW</a>
              </div>
            </div>
