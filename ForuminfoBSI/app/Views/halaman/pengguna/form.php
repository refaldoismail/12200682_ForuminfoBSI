        ...
        <div class="col-md-5">
            <div class='card'>
                    <div class="card-header">
                        <h3 class="card title">FORUM INFO BSI</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post"action="/pengguna">
                            ...
                            <div>
                                <label for="txtPassword" class="form-label">Ulangi Kata Sandi</label>
                                <input id="txtPassword" type="password" name="password2" value="" class="form-control"/>
                                <?php 
                            ...
                            <br>
                            <button class="btn btn-sn btn-primary">Simpan</button>
